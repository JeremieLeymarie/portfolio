    ...
    return (
        <Box className="contact-wrapper">
            ...
            <Box className="contact-icons" sx={{ marginTop: "2rem", display: "flex", gap: "2rem", backgroundColor: "#001D3D", padding: "1rem 2rem", borderRadius: "1rem" }}>
                <a rel="noreferrer" href="https://github.com/JeremieLeymarie" title="GitHub" target="_blank" alt="GitHub Profile Jérémie Leymarie web developper">
                    <svg
                ...
                <a rel="noreferrer" title="LinkedIn" href="https://www.linkedin.com/in/jeremie-leymarie/" target="_blank" alt="LinkedIn Profile Jérémie Leymarie web developper">
                    <svg
                        className="social-icon"
                        xmlns="http://www.w3.org/2000/svg"
                        width="45"
                ...
                <a rel="noreferrer" title="Codingame" href="https://www.codingame.com/profile/f5b7f2d325e69b084fd8cb41b641de440341234" target="_blank" alt="Codingame Profile Jérémie Leymarie web developper">
                ...
                <a rel="noreferrer" title="Resume" href="CV_JeremieLeymarie.pdf" /* download="CV_JeremieLeymarie.pdf" */ target="_blank" alt="Resume Jérémie Leymarie web developper">
