...
function Project({ data }) {
    ...
    return (
        <Box className={"project-wrapper " + data.className}>
            ...
            <a href={ data.see ? data.see  : data.source} target="_blank"
            ...
            <Box className="project-text-wrapper">
                <Box className="project-header">
                    ...
                    <a href={data.source} target="_blank" alt={data.name + " Jérémie Leymarie"}><Box className="project-github">See source</Box></a>
                </Box>
                ...
                {data.see &&
                    <a href={data.see} target="_blank"><Box className="project-test">See the project <span className="underline">here</span></Box></a>
                }
